...
import com.YaNan.frame.hibernate.database.transaction.exception.TransactionExistsException;
import com.YaNan.frame.hibernate.database.transaction.exception.TransactionIsNotExistsException;
	...
	public static void resetTransactionPointer() {
		...
		if(currentTransaction != null) {
			if(currentTransaction.getParentTransaction() != null) {
				...
				logger.debug("all transaction completed at transaction "+currentTransaction);
